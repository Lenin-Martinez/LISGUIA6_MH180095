...
//Si no se está usando un archivo con usuario y contraseña en el
servidor
//utilizar estos datos de usuario y contraseña
if($_SERVER['PHP_AUTH_USER'] != 'lis' || $_SERVER['PHP_AUTH_PW']
!= ingenieria){
...
//Si estamos acá es porque el usuario introdujo los datos
correctos
